...
function buildServer() {
  const server = new McpServer(
    { name: "FixProof", version: "0.5.0", websiteUrl: "https://fixproof-alexa.keyvan-andayesh.chatgpt.site" },
    {
      capabilities: { tools: {} },
      instructions: "Public judge endpoint for fictional FixProof evaluations. Use only the three listed exact Bosch models and fictional_demo=true. Never send personal or real appliance data. Only explicit user outcomes count as attempted. Never claim a diagnosis, physical inspection, or verified repair.",
    },
  );
