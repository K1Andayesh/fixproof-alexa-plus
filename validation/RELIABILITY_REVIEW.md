...
- A second exact Bosch model has its own official service page, manual identity, verified hash and page map for all fourteen checks. Browser and MCP handovers carry the selected catalog without mixing citations from the first model.
...
The revised interface was exercised and visually inspected in a browser from the local release candidate, including second-model selection, page citations, recorded evidence, handover provenance and reload/resume. This is developer QA, not an independent user or repair-professional evaluation. Production verification is recorded below after deployment.
