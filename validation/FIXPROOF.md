...
One browser case that goes from a reported dishwasher drying, food-remnant, detergent-residue, removable-streak, wash-noise or cutlery-rust problem to a concise repair handover: exact model, verified reference, user-confirmed attempts, observed outcomes, and questions still unresolved.
...
Pages 23, 27, 36, 37, 40, 41, 42, 44, 45 and 48 were extracted and visually inspected. Pages 36–37 show filter maintenance; page 42 lists causes and checks for food remnants and detergent residue; pages 23, 40 and 41 support the drying path; pages 23, 27, 44 and 45 support the removable-streak path; page 48 supports the wash-noise path; and page 45 supports the cutlery-rust path. SHA-256: `af965b35d3447c81adfc56bf652f75f8da565d47a9d4dc9c1e55030ae521a47c`. The public-facing catalog contains original short summaries and page links, not the full manual. Downloaded PDF and rendered pages remain under ignored `tmp/`.
...
Pages 24-25, 28, 38-39, 44-46, 48-49 and 52 were extracted and visually inspected. They support the same nineteen application-owned check summaries, with model-specific page mappings; page 49 supports the cutlery-rust path. SHA-256: `b2bb4608cd266752804e8c02b3e251bb31e6c32f95824e602614b13f83240fc9`. Each case now carries its selected model's manual URL, service URL, page citations and source hash through the browser and MCP handover.
...
Pages 23-24, 27-28, 36-37, 41-46 and 49-50 were extracted and visually inspected. They support the same nineteen check summaries and both informational results with a third independent page map; page 46 supports the cutlery-rust path. SHA-256: `b499156281a114882fd254e11400bc6318db71020eab2c4cfac9848264b4b476`.
...
The ordered technical work above is implemented in `fixproof/`; see [QA evidence](FIXPROOF_QA.md). Local Qwen 3.5 4B classifies user symptoms and selects from nineteen source-backed checks across drying, food-remnant, detergent-residue, removable-streak, wash-noise and cutlery-rust paths after excluding recorded checks. The server supplies instructions and references. User actions alone record outcomes and status. Explicit revisiting preserves prior history. Markdown export contains recorded facts and identified uncertainties.
